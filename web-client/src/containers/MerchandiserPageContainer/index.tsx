...
import DashboardApiClient from "api/merchandiser/DashboardApiClient";
...
import TransactionApiClient from "api/merchandiser/TransactionApiClient";
...
const MerchandiserPageContainer: React.FC = () => {
    ...
    dashboardApiClient
      ...
      .then(res => setDeposit(res.deposit)).then(() => {
        transactionApiClient
          .getAllTransactions(pageTransactions)
          .then(trans => {
            ...
            <Box className={styles.tableAction}>
              <Box className={styles.btnGroup}>
                <ButtonGroup variant="text" color="primary" aria-label="text primary button group">
                  <Button className={styles.btn}>{t("deposit")}</Button>
                  <Button className={styles.btn}>{t("withdraw")}</Button>
                </ButtonGroup>
              </Box>
...
export default MerchandiserPageContainer;
